      ...
      <div className="mx-auto max-w-4xl rounded-2xl bg-white p-8 shadow-sm">
        ...
        <div className="mt-10">
          <button
            ...
            className="rounded-full bg-slate-900 px-6 py-3 font-medium text-white disabled:cursor-not-allowed disabled:opacity-60"
          >
            {joined ? "You're Attending" : joining ? "Joining..." : "Join Conference"}
          </button>
        </div>
        ...
        <section className="mt-10 rounded-2xl bg-slate-50 p-6">
          ...
          <div className="mt-4 space-y-3">
            {attendees.length > 0 ? (
              ...
              <p className="text-slate-600">No attendees yet. Be the first to join.</p>
            )}
          </div>
        </section>
      </div>
